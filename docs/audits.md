...
import AuditReportsTable from '@site/src/components/AuditReportsTable';
...
<AuditReportsTable
  rows={[
    ...
    {
      report: 'Covered Vault',
      auditor: 'Certora',
      auditorUrl: 'https://www.certora.com/',
      date: 'March 2026',
      href: '/audits/catalysis-covered-vault-audit.pdf',
    },
    {
